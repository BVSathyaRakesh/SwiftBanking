...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.setNavBarAppearance(tintColor: .white, barColor: #colorLiteral(red: 0.09019608051, green: 0, blue: 0.3019607961, alpha: 1))
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "LoginNavID")
    }
